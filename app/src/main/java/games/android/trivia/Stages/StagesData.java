...
public class StagesData{
    ...
    HashMap<Integer,Stage> getStages() {
        ...
        stages.put(3,new Stage(3, 5000, 10000, QuestionBank.QuestionDifficulty.EASY));
        ...
        stages.put(6,new Stage(6, 50000, 100000, QuestionBank.QuestionDifficulty.MEDIUM));
        stages.put(7,new Stage(7, 100000, 200000, QuestionBank.QuestionDifficulty.MEDIUM));
