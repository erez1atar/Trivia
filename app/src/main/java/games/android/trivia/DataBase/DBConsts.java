...
public class DBConsts {
    ...
    public static final String SQL_CREATE_SCORES_TB = "CREATE TABLE IF NOT EXISTS " + FeedEntry.SCORES_TABLE_NAME + " ( " + FeedEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL " + COMMA_SKP + FeedEntry.SCORES_COLUMN_DATE + TEXT_TYPE + COMMA_SKP + FeedEntry.SCORES_COLUMN_NAME + INTEGER_TYPE + COMMA_SKP + FeedEntry.SCORES_COLUMN_SCORE + INTEGER_TYPE  +" );";
    ...
    "UPDATE "+ DBConsts.FeedEntry.SCORES_TABLE_NAME + " SET " + DBConsts.FeedEntry.SCORES_COLUMN_SCORE + "=?" + " , " + DBConsts.FeedEntry.SCORES_COLUMN_NAME + "=?" + " , " + DBConsts.FeedEntry.SCORES_COLUMN_DATE+ "=?"  +"  WHERE " + DBConsts.FeedEntry._ID + "=?";
    public static final int UPDATE_SCORE_IDX = 1;
    public static final int UPDATE_NAME_IDX = 2;
    public static final int UPDATE_DATE_IDX = 3;
    public static final int UPDATE_ID_IDX = 4;
    ...
    "INSERT INTO " + FeedEntry.SCORES_TABLE_NAME +  " ( " + FeedEntry.SCORES_COLUMN_DATE + COMMA_SKP + FeedEntry.SCORES_COLUMN_SCORE + COMMA_SKP  + FeedEntry.SCORES_COLUMN_NAME + " ) VALUES (?,?,?)";
    public static final int INSERT_DATE_IDX = 1;
    public static final int INSERT_SCORE_IDX = 2;
    public static final int INSERT_NAME_IDX = 3;
